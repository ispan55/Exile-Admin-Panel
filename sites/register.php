<?php require_once(ROOT_PATH . 'include/Register.php')?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>ExileAdmin | Registration Page</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="dashboard.php"><b>Exile</b>Admin</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form action="" method="post">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4 bottom-buffer">
...
<?php if (isset($_SESSION['error'])) { ?>
    <script>$('#modal').modal({show: true})</script>
