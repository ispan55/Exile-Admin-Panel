...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both Exile-Mod-Admin-Panel.css and Exile-Mod-Admin-Panel.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/AdminLTE.css": "build/less/Exile-Mod-Admin-Panel.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/AdminLTE.min.css": "build/less/Exile-Mod-Admin-Panel.less",
          // Skins minified
    ...
    csslint: {
      ...
      dist: [
        'dist/css/Exile-Mod-Admin-Panel.css',
      ]
    },
